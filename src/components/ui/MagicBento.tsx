...
const DEFAULT_GLOW_COLOR = '0, 0, 0'; // Changed to black
...
const cardData: BentoCardProps[] = [
  ...
  },
  {
    ...
    description: 'Data-driven insights that drive real results',
    label: 'Performance',
  ...
  },
  {
    ...
    label: 'Team',
    backgroundImage: 'https://images.unsplash.com/photo-1522202176988-66273c2fd55f?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80',
    countUp: {
      to: 25,
      from: 0,
      suffix: '+',
  ...
  },
  {
    ...
    label: 'Experience',
    backgroundImage: 'https://images.unsplash.com/photo-1551434678-e076c223a692?q=80&w=2340&auto=format&fit=crop',
    countUp: {
      to: 8,
      from: 0,
      suffix: '+',
...
const ParticleCard: React.FC<{
  ...
  useEffect(() => {
    ...
    const handleMouseEnter = () => {
      ...
      if (backgroundImage) {
        gsap.to(element.querySelector('.card-background'), {
          opacity: 0.3,
          duration: 0.5,
          ease: 'power2.out'
        });
  ...
  }, [animateParticles, clearAllParticles, disableAnimations, enableTilt, enableMagnetism, clickEffect, glowColor, backgroundImage]);
  ...
  return (
    ...
    >
      {backgroundImage && (
        <div
          className="card-background absolute inset-0 opacity-0 transition-opacity duration-500 bg-cover bg-center bg-no-repeat"
          style={{
      ...
      <style>
        {`
          .bento-section {
            ...
            --border-color: #333; /* Changed to dark gray */
            --background-dark: #000; /* Changed to black */
            --white: hsl(0, 0%, 100%);
            --purple-primary: rgba(0, 0, 0, 1); /* Changed to black */
            --purple-glow: rgba(0, 0, 0, 0.2); /* Changed to black */
            --purple-border: rgba(0, 0, 0, 0.8); /* Changed to black */
          }
          ...
          .count-up-number {
            ...
            text-shadow: 0 0 10px rgba(${glowColor}, 0.5);
            line-height: 1;
          }
                  ...
                  <div className="card__content flex flex-col relative text-white">
                    {card.countUp && (
                      <div className="mb-3">
                        ...
                        />
                        {card.countUp.suffix && (
                          <span className="count-up-number">{card.countUp.suffix}</span>
                        )}
                      </div>
                    )}
                ...
                ref={el => {
                  ...
                  const handleMouseEnter = () => {
                    if (card.backgroundImage) {
                      const backgroundEl = el.querySelector('.card-background') as HTMLElement;
                      if (backgroundEl) {
